...
// configure
$from = 'rjhinostrozagarcia@miners.utep.edu'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'raulhinostroza4@gmail.com'; // Replace it with Your email. REQUIRED!
